...
class Single_Product extends Base_View {
	...
	private function is_product_nav_active() {
		if ( function_exists( 'wpcom_vip_get_adjacent_post' ) ) {
			...
			$next_post = get_next_post( true, '', 'product_cat' ); //phpcs:ignore WordPressVIPMinimum.Functions.RestrictedFunctions.get_adjacent_post_get_next_post
			$prev_post = get_previous_post( true, '', 'product_cat' ); //phpcs:ignore WordPressVIPMinimum.Functions.RestrictedFunctions.get_adjacent_post_get_previous_post
		}
